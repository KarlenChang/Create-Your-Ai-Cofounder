...
Then ask one at a time (don't dump all questions at once):
...
- If the user doesn't know an answer, write "TBD" and move on
- Tell them: "The goal isn't perfection — it's getting your assumptions on paper so you can test them"
- After all questions are answered, generate the HTML and save to brain
